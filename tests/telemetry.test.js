...
describe('TelemetryManager', () => {
    describe('stream', () => {
        ...
        it('throws when metric is a non-* string', async () => {
            ...
            await expect(
                tm.stream({ device_ident: 'sensor_01', metric: 'temperature', callback: () => {} })
        ...
        it('throws when metric is not string or array', async () => {
            ...
            await expect(
                tm.stream({ device_ident: 'sensor_01', metric: 123, callback: () => {} })
        ...
        it('throws when metric is an empty array', async () => {
            ...
            await expect(
                tm.stream({ device_ident: 'sensor_01', metric: [], callback: () => {} })
        ...
        it('validates each metric in array against device schema', async () => {
            ...
            await expect(
                tm.stream({ device_ident: 'sensor_01', metric: ['temperature', 'nonexistent'], callback: () => {} })
    ...
    describe('off', () => {
        ...
        it('with metric array removes metrics from filtered subscriptions', async () => {
            ...
            await tm.stream({ device_ident: 'sensor_01', metric: ['temperature', 'humidity'], callback: () => {} });
        ...
        it('leaves wildcard subscriptions untouched when off called with specific metrics', async () => {
            ...
            await tm.stream({ device_ident: 'sensor_01', metric: '*', callback: () => {} });
            await tm.stream({ device_ident: 'sensor_01', metric: ['temperature'], callback: () => {} });
                    ...
                    return {
                        data: msgpackEncode({
                            ...
                            data: {
                                has_more: false,
                                cursor: null,
                                data: { temperature: [{ value: 23.5, time: '2025-01-01T12:00:00Z' }] },
                            },
                        }),
                    };
                }
    ...
    describe('validation', () => {
        it('throws on invalid ident', async () => {
            ...
            await expect(
                tm.stream({ device_ident: 'bad ident!', metric: '*', callback: () => {} })
    ...
    describe('latest', () => {
        it('sends history request with last_value true', async () => {
                ...
                if (subject === 'api.iot.db.test_org_123.telemetry.history') {
                    return {
                        data: msgpackEncode({
                            status: 'TELEMETRY_FETCH_SUCCESS',
                            data: {
                                data: { temperature: [{ value: 23.5, time: '2026-03-24T00:00:00Z' }] },
                            },
                        }),
                    };
                }
            ...
            expect(result).toEqual({ temperature: { value: 23.5, time: '2026-03-24T00:00:00Z' } });
        });
        ...
        it('throws on missing fields', async () => {
            ...
            await expect(
                tm.latest({ device_ident: 'sensor_01', start: '2026-03-23T00:00:00.000Z', end: '2026-03-24T00:00:00.000Z' })
            ).rejects.toThrow('non-empty array');
        });
        ...
        it('throws on missing device_ident', async () => {
            ...
            await expect(
                tm.latest({ fields: ['temperature'], start: '2026-03-23T00:00:00.000Z', end: '2026-03-24T00:00:00.000Z' })
