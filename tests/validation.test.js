...
describe("validateIdent", () => {
  ...
  it("rejects dots", () => {
    expect(() => validateIdent("my.ident", "field")).toThrow(
      /invalid characters/,
    );
  });
...
describe("validateHierarchyName", () => {
  ...
  it("rejects spaces", () => {
    expect(() => validateHierarchyName("my name", "field")).toThrow(
      /invalid characters/,
    );
  });

  it("rejects wildcards", () => {
    expect(() => validateHierarchyName("my.*", "field")).toThrow(
      /invalid characters/,
    );
  });
  ...
  it("rejects non-string (number)", () => {
    expect(() => validateHierarchyName(42, "field")).toThrow(
      /must be a string/,
    );
  });

  it("rejects non-string (array)", () => {
    expect(() => validateHierarchyName([], "field")).toThrow(
      /must be a string/,
    );
  });
});
...
describe("validateHierarchyWildcard", () => {
  ...
  it("accepts underscores and hyphens", () => {
    expect(() =>
      validateHierarchyWildcard("my_name-here", "field"),
    ).not.toThrow();
  });
  ...
  it("rejects spaces", () => {
    expect(() => validateHierarchyWildcard("a b", "field")).toThrow(
      /invalid characters/,
    );
  });
  ...
  it("rejects undefined", () => {
    expect(() => validateHierarchyWildcard(undefined, "field")).toThrow(
      /required/,
    );
  });

  it("rejects non-string (number)", () => {
    expect(() => validateHierarchyWildcard(99, "field")).toThrow(
      /must be a string/,
    );
  });

  it("rejects non-string (boolean)", () => {
    expect(() => validateHierarchyWildcard(false, "field")).toThrow(
      /must be a string/,
    );
  });
...
describe("validateFunction", () => {
  ...
  it("rejects a string", () => {
    expect(() => validateFunction("notAFunction", "field")).toThrow(
      /must be a function/,
    );
  });
...
describe("validateNonEmptyArray", () => {
  ...
  it("rejects null", () => {
    expect(() => validateNonEmptyArray(null, "field")).toThrow(
      /non-empty array/,
    );
  });

  it("rejects undefined", () => {
    expect(() => validateNonEmptyArray(undefined, "field")).toThrow(
      /non-empty array/,
    );
  });

  it("rejects a string", () => {
    expect(() => validateNonEmptyArray("abc", "field")).toThrow(
      /non-empty array/,
    );
  });
...
describe("validateObject", () => {
  ...
  it("rejects undefined", () => {
    expect(() => validateObject(undefined, "field")).toThrow(
      /must be an object/,
    );
  });
...
describe("validatePositiveNumber", () => {
  ...
  it("rejects a negative number", () => {
    expect(() => validatePositiveNumber(-1, "field")).toThrow(
      /non-negative number/,
    );
  });

  it("rejects NaN", () => {
    expect(() => validatePositiveNumber(NaN, "field")).toThrow(
      /non-negative number/,
    );
  });

  it("rejects a string", () => {
    expect(() => validatePositiveNumber("5", "field")).toThrow(
      /non-negative number/,
    );
  });

  it("rejects null", () => {
    expect(() => validatePositiveNumber(null, "field")).toThrow(
      /non-negative number/,
    );
  });

  it("rejects undefined", () => {
    expect(() => validatePositiveNumber(undefined, "field")).toThrow(
      /non-negative number/,
    );
  });
});
...
describe("validateISO8601", () => {
  it("accepts a valid ISO8601 date string", () => {
    expect(() =>
      validateISO8601("2024-01-15T10:30:00.000Z", "field"),
    ).not.toThrow();
  });

  it("rejects a date-only string (no round-trip)", () => {
    expect(() => validateISO8601("2024-01-15", "field")).toThrow(
      /valid ISO8601/,
    );
  });

  it("rejects a datetime with timezone offset (no round-trip)", () => {
    expect(() => validateISO8601("2024-01-15T10:30:00+05:30", "field")).toThrow(
      /valid ISO8601/,
    );
  });
  ...
  it("rejects an invalid date string", () => {
    expect(() => validateISO8601("not-a-date", "field")).toThrow(
      /valid ISO8601/,
    );
  });
...
describe("validateStartBeforeEnd", () => {
  it("accepts when start is before end", () => {
    expect(() =>
      validateStartBeforeEnd("2024-01-01", "2024-01-02"),
    ).not.toThrow();
  });

  it("accepts when start is well before end", () => {
    expect(() =>
      validateStartBeforeEnd("2020-01-01T00:00:00Z", "2025-12-31T23:59:59Z"),
    ).not.toThrow();
  });

  it("throws when start equals end", () => {
    expect(() =>
      validateStartBeforeEnd("2024-01-01T00:00:00Z", "2024-01-01T00:00:00Z"),
    ).toThrow(/start must be before end/);
  });

  it("throws when start is after end", () => {
    expect(() => validateStartBeforeEnd("2024-06-01", "2024-01-01")).toThrow(
  ...
  it("works with ISO8601 datetime strings", () => {
    expect(() =>
      validateStartBeforeEnd("2024-01-01T10:00:00Z", "2024-01-01T11:00:00Z"),
    ).not.toThrow();
  });

  it("throws when times differ by milliseconds but start >= end", () => {
    expect(() =>
      validateStartBeforeEnd("2024-01-01T00:00:01Z", "2024-01-01T00:00:00Z"),
    ).toThrow(/start must be before end/);
  });
});
...
describe("validateEventName", () => {
  ...
  it("rejects invalid characters", () => {
    expect(() => validateEventName("door.opened")).toThrow(
      /invalid characters/,
    );
    expect(() => validateEventName("door opened")).toThrow(
      /invalid characters/,
...
describe("validateCommandName", () => {
  ...
  it("rejects invalid characters", () => {
    expect(() => validateCommandName("set config")).toThrow(
      /invalid characters/,
    );
  });
});
...
describe("validateTelemetryMetric", () => {
  ...
  it("rejects invalid characters", () => {
    expect(() => validateTelemetryMetric("cpu.usage")).toThrow(
      /invalid characters/,
    );
  });
});
